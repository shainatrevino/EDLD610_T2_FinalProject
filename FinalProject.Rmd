...
(n = 31), medium WMC (n = 69) individuals, and high WMC (n = 33) individuals.",
...
plot3 <- plot3_data %>%
  ...
  ggplot(aes(x = bin, y = mean_TEPR, color = span_group)) +
      ...
      labs(caption = "Figure 3. Pupil diameter as a function of serial position and time across encoding period for low WMC (n = 31), medium WMC (n = 69), 
and high WMC (n = 33) individuals. Serial position was broken down into Primacy (words 1–3), Mid (words 4–7), and Recency (words 8–
10) for graphical purposes only.",
           y = "Mean Pupillary Response (mm)",
           x = "Time (ms)",
           colour = "WMC") +
