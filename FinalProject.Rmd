...
bbg_darktheme <- theme(panel.grid.major = element_line(colour = "gray30"), 
...
For the original figure in Miller, Gross, and Unsworth, I faceted by WMC rather than serial position. Let's try to re-create that plot and compare (note, I prefer the above where I facet by serial position):
...
### Plot 4
#### First attempt to plot relation between recall accuracy and strategy type   
